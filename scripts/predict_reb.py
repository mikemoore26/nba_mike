...
def _auto_relax_active_within_days(
    *,
    ...
    relaxed = gap_days + 7
    print(
        f"[REB] Relaxing active_within_days from {active_within_days} to {relaxed} "
...
def predict_reb_for_date(
    *,
    ...
    """
    Predict REB means for a specific slate date.
