...
def _auto_relax_active_within_days(
    *,
    ...
    relaxed = gap_days + 7
    print(
        f"[PTS] Relaxing active_within_days from {active_within_days} to {relaxed} "
...
def predict_pts_for_date(
    *,
    ...
    """
    Predict PTS means for a specific slate date.
